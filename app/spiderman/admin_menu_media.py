...
_SLOT_LABELS = {
    ...
    SLOT_BUY: "💎 Купить подписку",
    SLOT_TARIFF_STANDARD: "🕷️ Standard (Питер Паркер)",
    SLOT_TARIFF_WHITE: "⚪️ White (Саша Белый)",
    SLOT_SUPPORT: "🆘 Техподдержка",
    SLOT_SUBSCRIPTION: "📦 Подписка",
    SLOT_REFERRAL: "🤝 Партнёрка",
    SLOT_PURCHASE_SUCCESS: "🎉 Подписка успешно приобретена",
